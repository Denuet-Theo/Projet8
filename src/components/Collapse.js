        ...
        <div className="collapse bg-base-200 w-[70%] m-auto">
            ...
            <div className="collapse-content">
                ...
                <div className="collapse-content mr-[5px] sm:mr-0 leading-[42px]">
                    <p className="m-auto sm:text-3xl text-2xl pt-10 pb-10">Etant encore un jeune devellopeur, je cherche avant tout a continuer d'apprendre, continuer de m'améliorer dans les domaines
